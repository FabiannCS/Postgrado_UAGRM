  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4">
      ...
      <motion.div 
        ...
        className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 min-h-[550px]"
      >
        
        {/* SECCIÓN 1: LADO IZQUIERDO (Visual / Branding UAGRM) 
            CAMBIO: order-2 (abajo en móvil), md:order-1 (izquierda en PC)
        */}
        <div className="relative flex flex-col justify-between p-8 md:p-10 text-white bg-blue-900 overflow-hidden order-2 md:order-1 min-h-[200px]">
        ...
        */}
        <div className="p-8 md:p-12 flex flex-col justify-center bg-white relative order-1 md:order-2">
            
            <div className="mb-6 md:mb-8 text-center md:text-left">
                <h2 className="text-3xl font-bold text-slate-900 text-center">Bienvenido</h2>
                <p className="text-sm text-slate-500 mt-2 text-center">Ingresa tus credenciales institucionales.</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-5">
                
                <div className="space-y-2">
                    <Label htmlFor="identifier" className="text-slate-700 font-medium">Registro o Correo</Label>
                    <div className="relative group">
                        <User className="absolute left-3 top-3 h-4 w-4 text-slate-400 group-focus-within:text-blue-700 transition-colors" />
                        <Input 
                            id="identifier" 
                            type="text" 
                            placeholder="Ej: 219004589" 
                            className="pl-10 h-11 bg-slate-50 border-slate-200 focus:bg-white focus:border-blue-700 focus:ring-blue-700/20 transition-all"
                            required 
                        />
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        <Lock className="absolute left-3 top-3 h-4 w-4 text-slate-400 group-focus-within:text-blue-700 transition-colors" />
                        <Input 
                            id="password" 
                            type={showPassword ? "text" : "password"} 
                            placeholder="••••••••" 
                            className="pl-10 pr-10 h-11 bg-slate-50 border-slate-200 focus:bg-white focus:border-blue-700 focus:ring-blue-700/20 transition-all"
                            required 
                        />
                        <button
                            type="button"
                    ...
                    <div className="flex justify-end">
                        <Link href="#" className="text-sm font-medium text-blue-700 hover:text-blue-900 hover:underline transition-colors">
                ...
                <Button 
                    type="submit" 
                    className="w-full h-11 mt-4 bg-blue-900 hover:bg-blue-800 text-white font-medium shadow-lg shadow-blue-900/10 transition-all active:scale-[0.98]" 
                    disabled={isLoading}
                >
                    {isLoading ? (
                        <>
