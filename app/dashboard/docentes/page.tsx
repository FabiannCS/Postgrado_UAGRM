  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Mis Docentes</h1>
        <p className="text-sm text-slate-500">Información de contacto y perfil profesional.</p>
      </div>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 border-slate-200 group">
              ...
              <CardContent className="flex flex-col items-center -mt-12 text-center pb-6">
                ...
                <div className="mt-4 space-y-1">
                    ...
                    <Badge variant="secondary" className="font-medium text-slate-800 bg-slate-100 text-sm">
                        {teacher.subject}
                    </Badge>
                </div>
                ...
                <div className="mt-6 w-full space-y-3 px-4">
                    <a href={`mailto:${teacher.email}`} className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 transition-colors text-sm text-slate-600 border border-transparent hover:border-slate-100">
                        <div className="bg-blue-50 p-2 rounded-full text-blue-600">
                            <Mail className="h-4 w-4" />
                        </div>
                        <span className="truncate">{teacher.email}</span>
                    </a>
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 transition-colors text-sm text-slate-600 border border-transparent hover:border-slate-100">
              ...
              <CardFooter className="p-4 bg-slate-50/50">
                ...
                <Dialog>
                    <DialogTrigger asChild>
                        <Button className="w-full bg-slate-900 hover:bg-blue-800 text-white shadow-md group-hover:shadow-blue-900/20 transition-all">
                            <FileText className="mr-2 h-4 w-4" />
                            Ver Currículum Completo
                        </Button>
                    </DialogTrigger>
                    
                    <DialogContent className="max-w-2xl max-h-[85vh] p-0 overflow-hidden rounded-xl">
                        {/* Header del Modal */}
                        ...
                        <ScrollArea className="h-full max-h-[60vh] p-6 bg-white">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-2 pt-1">
                                        {teacher.cv.skills.map((skill, i) => (
                                            <Badge key={i} variant="secondary" className="px-3 py-1 bg-slate-100 text-slate-700 hover:bg-blue-50 hover:text-blue-700 border-slate-200">
                                                {skill}
                                            </Badge>
                                        ))}
                                    </div>
