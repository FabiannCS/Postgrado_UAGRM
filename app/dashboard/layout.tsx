...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-slate-50 dark:bg-slate-950">
      ...
      {/* Footer simple */}
      <footer className="py-6 text-center text-xs text-slate-400 dark:text-slate-600 hover:text-uagrm-blue dark:hover:text-blue-400 transition-colors cursor-default">
