...
import { ChevronLeft, Info, BookOpen, AlertTriangle } from "lucide-react";
import { motion } from "framer-motion";

import { programsData, programModules } from "../data";
  ...
  return (
    ...
    >
      ...
      <Tabs defaultValue="info" className="w-full">
        ...
        <TabsList className="grid w-full grid-cols-2 lg:grid-cols-3 mb-8 h-auto">
